...
//	int regno;
	String faculty;
	protected int allbookid[]=new int[3];
	...
	public int signup(int user_c) {
      ...
      //  System.out.println("enter regno\n");
       ...
       // regno= scan10.nextInt();
        
        System.out.println("enter faculty\n");
        Scanner scan11= new Scanner(System.in);
        faculty = scan11.nextLine();
        ...
        public void updateinfo() {
     	...
     	public void returnBook(Magazine mag[],Fyp fyp[],books book[],int book_c)
     	{
     		...
     		//System.out.println(gg+" "+gg2+""+mag[gg-1].getid()+" "+mag[gg-1].issuedby+" "+id);
     		switch(gg2)
     		{
     		case 1:
